...
build:generate
	...
	go build -o ./bin/im-server ./internal/im_server
...
build-all:generate lint
	...
	CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o ./build/windows/bin/im-server.exe ./internal/im_server
	...
	CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ./build/linux/bin/im-server ./internal/im_server
	...
	CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -o ./build/mac/bin/im-server ./internal/im_server
	...
	CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -o ./build/macm1/bin/im-server ./internal/im_server
