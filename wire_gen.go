...
func Initialize(ctx context.Context, conf *config.Config) *provider.Services {
	...
	talkMessageService := service.NewTalkMessageService(baseService, conf, groupMemberService, unreadTalkCache)
