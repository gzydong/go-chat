...
const file_web_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x11web/v1/auth.proto\x12\x03web\x1a\x17validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\"\x9a\x01\n" +
	"\x10AuthLoginRequest\x12#\n" +
	"\x06mobile\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\vR\x06mobile\x12'\n" +
	"\bpassword\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\bpassword\x128\n" +
	"\bplatform\x18\x03 \x01(\tB\x1c\xe2A\x01\x02\xfaB\x15r\x13R\x03webR\awindowsR\x03macR\bplatform\"{\n" +
	...
	"\bnickname\x18\x01 \x01(\tB\t\xfaB\x06r\x04\x10\x02\x18\x14R\bnickname\x12 \n" +
	"\x06mobile\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x98\x01\vR\x06mobile\x12#\n" +
	"\bpassword\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\bpassword\x124\n" +
	"\bplatform\x18\x04 \x01(\tB\x18\xfaB\x15r\x13R\x03webR\awindowsR\x03macR\bplatform\x12#\n" +
	"\bsms_code\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x98\x01\x06R\asmsCode\"~\n" +
	...
	"\x06mobile\x18\x01 \x01(\tB\f\xe2A\x01\x02\xfaB\x05r\x03\x98\x01\vR\x06mobile\x12'\n" +
	"\bpassword\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\bpassword\x12'\n" +
	"\bsms_code\x18\x03 \x01(\tB\f\xe2A\x01\x02\xfaB\x05r\x03\x98\x01\x06R\asmsCode\"\x14\n" +
	"\x12AuthForgetResponse\"K\n" +
	"\x10AuthOauthRequest\x127\n" +
	"\n" +
	"oauth_type\x18\x03 \x01(\tB\x18\xe2A\x01\x02\xfaB\x11r\x0fR\x06githubR\x05giteeR\toauthType\"+\n" +
	"\x11AuthOauthResponse\x12\x16\n" +
	"\x03uri\x18\x01 \x01(\tB\x04\xe2A\x01\x02R\x03uri\"\x94\x01\n" +
	"\x15AuthOauthLoginRequest\x127\n" +
	"\n" +
	"oauth_type\x18\x03 \x01(\tB\x18\xe2A\x01\x02\xfaB\x11r\x0fR\x06githubR\x05giteeR\toauthType\x12\x1f\n" +
	"\x04code\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x04code\x12!\n" +
	"\x05state\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x05state\"\x9a\x01\n" +
	...
	"\n" +
	"bind_token\x18\x01 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\tbindToken\x12#\n" +
	"\x06mobile\x18\x02 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x06mobile\x12&\n" +
	"\bsms_code\x18\x03 \x01(\tB\v\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\asmsCode\"K\n" +
