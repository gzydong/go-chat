...
const file_web_v1_group_proto_rawDesc = "" +
	"\n" +
	"\x12web/v1/group.proto\x12\x03web\x1a\x17validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\"\x12\n" +
	...
	"\buser_ids\x18\x02 \x03(\x05B\b\xfaB\x05\x92\x01\x02\b\x01R\auserIds\"6\n" +
	"\x13GroupCreateResponse\x12\x1f\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\x04\xe2A\x01\x02R\agroupId\"8\n" +
	"\x12GroupDetailRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\"\xb3\x04\n" +
	...
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\"\xd5\x02\n" +
	...
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\"\x16\n" +
	"\x14GroupDismissResponse\"]\n" +
	"\x12GroupInviteRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\x12#\n" +
	"\buser_ids\x18\x02 \x03(\x05B\b\xfaB\x05\x92\x01\x02\b\x01R\auserIds\"\x15\n" +
	"\x13GroupInviteResponse\"=\n" +
	"\x17GetInviteFriendsRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x00R\agroupId\"\xfe\x01\n" +
	...
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\"\x15\n" +
	"\x13GroupSecedeResponse\"\x9d\x01\n" +
	"\x13GroupSettingRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\x12&\n" +
	"\n" +
	"group_name\x18\x02 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\tgroupName\x12\x16\n" +
	"\x06avatar\x18\x03 \x01(\tR\x06avatar\x12\"\n" +
	"\aprofile\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xff\x01R\aprofile\"\x16\n" +
	"\x14GroupSettingResponse\"V\n" +
	"\x18GroupRemarkUpdateRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\x12\x16\n" +
	"\x06remark\x18\x02 \x01(\tR\x06remark\"\x1b\n" +
	"\x19GroupRemarkUpdateResponse\"c\n" +
	"\x18GroupRemoveMemberRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\x12#\n" +
	"\buser_ids\x18\x02 \x03(\x05B\b\xfaB\x05\x92\x01\x02\b\x01R\auserIds\"\x1b\n" +
	"\x19GroupRemoveMemberResponse\"H\n" +
	"\x15GroupOvertListRequest\x12\x1b\n" +
	"\x04page\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\x04page\x12\x12\n" +
	...
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\x12 \n" +
	"\auser_id\x18\x02 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\x06userId\"\x17\n" +
	"\x15GroupHandoverResponse\"\x82\x01\n" +
	"\x17GroupAssignAdminRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\x12 \n" +
	"\auser_id\x18\x02 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\x06userId\x12!\n" +
	"\x06action\x18\x03 \x01(\x05B\t\xfaB\x06\x1a\x040\x010\x02R\x06action\"\x1a\n" +
	"\x18GroupAssignAdminResponse\"~\n" +
	"\x13GroupNoSpeakRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\x12 \n" +
	"\auser_id\x18\x02 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\x06userId\x12!\n" +
	"\x06action\x18\x03 \x01(\x05B\t\xfaB\x06\x1a\x040\x010\x02R\x06action\"\x16\n" +
	"\x14GroupNoSpeakResponse\"Y\n" +
	"\x10GroupMuteRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\x12!\n" +
	"\x06action\x18\x03 \x01(\x05B\t\xfaB\x06\x1a\x040\x010\x02R\x06action\"\x13\n" +
	"\x11GroupMuteResponse\"Z\n" +
	"\x11GroupOvertRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\agroupId\x12!\n" +
	"\x06action\x18\x03 \x01(\x05B\t\xfaB\x06\x1a\x040\x010\x02R\x06action\"\x14\n" +
