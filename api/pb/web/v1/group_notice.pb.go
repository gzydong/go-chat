...
type GroupNoticeEditRequest struct {
	...
	IsTop     int32  `protobuf:"varint,5,opt,name=is_top,json=isTop,proto3" json:"is_top,omitempty" binding:"oneof=1 2"`
	IsConfirm int32  `protobuf:"varint,6,opt,name=is_confirm,json=isConfirm,proto3" json:"is_confirm,omitempty" binding:"oneof=1 2"`
}
...
var file_web_v1_group_notice_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x69, 0x6e, 0x67, 0x3a, 0x22, 0x6f, 0x6e, 0x65, 0x6f, 0x66, 0x3d, 0x31, 0x20, 0x32,
	...
	0x66, 0x3d, 0x31, 0x20, 0x32, 0x22, 0x52, 0x09, 0x69, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72,
