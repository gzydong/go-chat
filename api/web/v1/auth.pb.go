...
type AuthLoginResponse struct {
	...
	Items     []*AuthLoginResponseList `protobuf:"bytes,4,rep,name=items,proto3" json:"items,omitempty"`
}
...
func (x *AuthLoginResponse) GetItems() []*AuthLoginResponseList {
	if x != nil {
		return x.Items
	}
	return nil
...
type AuthLoginResponseList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AuthLoginResponseList) Reset() {
	*x = AuthLoginResponseList{}
	if protoimpl.UnsafeEnabled {
...
func (x *AuthLoginResponseList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthLoginResponseList) ProtoMessage() {}

func (x *AuthLoginResponseList) ProtoReflect() protoreflect.Message {
	mi := &file_web_v1_auth_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthLoginResponseList.ProtoReflect.Descriptor instead.
func (*AuthLoginResponseList) Descriptor() ([]byte, []int) {
	return file_web_v1_auth_proto_rawDescGZIP(), []int{1, 0}
}

func (x *AuthLoginResponseList) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *AuthLoginResponseList) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *AuthLoginResponseList) GetExpiresIn() int64 {
	if x != nil {
		return x.ExpiresIn
	}
	return 0
...
var file_web_v1_auth_proto_rawDesc = []byte{
	...
	0x72, 0x02, 0x18, 0x0b, 0x52, 0x06, 0x6d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x12, 0x30, 0x0a, 0x08,
	...
	0x52, 0x08, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x22, 0xe0, 0x01, 0x0a, 0x11, 0x41,
	...
	0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x49, 0x6e, 0x12, 0x31, 0x0a, 0x05, 0x69, 0x74, 0x65,
	0x6d, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x77, 0x65, 0x62, 0x2e, 0x41,
	0x75, 0x74, 0x68, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x2e, 0x6c, 0x69, 0x73, 0x74, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x1a, 0x4f, 0x0a, 0x04,
	0x6c, 0x69, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01,
	...
	0x28, 0x03, 0x52, 0x09, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x49, 0x6e, 0x42, 0x0c, 0x5a,
...
var file_web_v1_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_web_v1_auth_proto_goTypes = []interface{}{
	...
	(*AuthLoginResponseList)(nil), // 2: web.AuthLoginResponse.list
}
var file_web_v1_auth_proto_depIdxs = []int32{
	2, // 0: web.AuthLoginResponse.items:type_name -> web.AuthLoginResponse.list
...
func file_web_v1_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_web_v1_auth_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthLoginResponseList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
