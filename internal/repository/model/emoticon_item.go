...
type EmoticonItem struct {
	...
	FileSuffix string    `gorm:"column:file_suffix;NOT NULL" json:"file_suffix"`           // 文件后缀名
	FileSize   int       `gorm:"column:file_size;default:0;NOT NULL" json:"file_size"`     // 文件大小（单位字节）
