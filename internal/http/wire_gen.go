...
func Initialize(conf *config.Config) *AppProvider {
	...
	talkMessageService := service.NewTalkMessageService(source, conf, unreadStorage, messageStorage, talkRecordsVote, groupMember, serverStorage, clientStorage, filesystem, splitUpload, repoSequence)
