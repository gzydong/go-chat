...
func Initialize(conf *config.Config) *AppProvider {
	...
	talkMessageService := service.NewTalkMessageService(baseService, conf, unreadStorage, messageStorage, talkRecordsVote, groupMember, serverStorage, clientStorage, filesystem, splitUpload, repoSequence)
	...
	groupService := service.NewGroupService(baseService, repoGroup, groupMember, relation, repoSequence)
	...
	message := talk.NewMessage(talkMessageService, talkService, talkRecordsVote, splitUploadService, contactService, groupMemberService, organizeService, talkAuthService, messageService, filesystem)
