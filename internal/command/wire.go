...
import (
	...
	cron2 "go-chat/internal/command/internal/handle/cron"
	other2 "go-chat/internal/command/internal/handle/other"
	queue2 "go-chat/internal/command/internal/handle/queue"
