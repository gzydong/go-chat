...
import (
	...
	cron2 "go-chat/internal/command/internal/command/cron"
	other2 "go-chat/internal/command/internal/command/other"
	"go-chat/internal/command/internal/command/queue"
	"go-chat/internal/command/internal/handle/cron"
