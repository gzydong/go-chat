...
import (
	...
	v12 "go-chat/internal/httpapi/handler/web/v1"
	article2 "go-chat/internal/httpapi/handler/web/v1/article"
	contact2 "go-chat/internal/httpapi/handler/web/v1/contact"
	group2 "go-chat/internal/httpapi/handler/web/v1/group"
	talk2 "go-chat/internal/httpapi/handler/web/v1/talk"
)
