...
func NewClient(conn IConn, option *ClientOption, event IEvent) error {
	...
	if client.storage != nil {
		err := client.storage.Bind(context.Background(), server.ID(), client.channel.Name(), client.cid, client.uid)
		if err != nil {
...
func (c *Client) hookClose(code int, text string) error {
	...
	if c.storage != nil {
		err := c.storage.UnBind(context.Background(), server.ID(), c.channel.Name(), c.cid)
		if err != nil {
