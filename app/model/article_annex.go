...
type ArticleAnnex struct {
	Id           int64     `gorm:"column:id;primary_key;AUTO_INCREMENT" json:"id"`   // 文件ID
	...
	FileSize     int64     `gorm:"column:file_size;default:0" json:"file_size"`      // 文件大小（单位字节）
	...
	DeletedAt    time.Time `gorm:"column:deleted_at" json:"deleted_at"`              // 附件删除时间
}
