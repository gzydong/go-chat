...
type VoteMessageHandleRequest struct {
	RecordId int    `form:"record_id" json:"record_id" binding:"required,min=1"`
...
type EmoticonMessageRequest struct {
	TalkType   int `form:"talk_type" json:"talk_type" binding:"required,oneof=1 2" label:"talk_type"`
	ReceiverId int `form:"receiver_id" json:"receiver_id" binding:"required,numeric,min=1" label:"receiver_id"`
	EmoticonId int `form:"emoticon_id" json:"emoticon_id" binding:"required,numeric,min=1"`
}
...
type CardMessageRequest struct {
	TalkType   int    `form:"talk_type" json:"talk_type" binding:"required,oneof=1 2" label:"talk_type"`
	ReceiverId int    `form:"receiver_id" json:"receiver_id" binding:"required,numeric,min=1" label:"receiver_id"`
	EmoticonId string `form:"emoticon_id" json:"emoticon_id" binding:"required,numeric,min=1"`
}
...
type RevokeMessageRequest struct {
	RecordId int `form:"record_id" json:"record_id" binding:"required,numeric,min=1" label:"record_id"`
}
